...
//Angular code
(function (){
	angular.module('escapeRoomsApp').controller('escapeRoomsReservationController', ['$scope', '$window', function($scope, $window) {
		//Properties
	...
	angular.module('escapeRoomsApp').directive("escapeRoomsReservationForm", function (){
		return {
			restrict: 'E',
			templateUrl:"view/templates/escapeRooms-reservation-form.html",
			controller:function(){

			},
			controllerAs: 'escapeRoomsReservationForm'
		};
	});
})();
